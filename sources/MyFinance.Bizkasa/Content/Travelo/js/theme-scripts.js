...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').each(function() {
        ...
        tjq(this).datepicker({
            showOn: 'both',
            buttonImage: 'blank.png'/*tpa=http://www.soaptheme.net/html/travelo/js/images/icon/blank.png*/,
            buttonText: '',
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travelo - home" href="http://www.soaptheme.net/html/travelo/js/index.html"><img alt="" src="logo-1.png"/*tpa=http://www.soaptheme.net/html/travelo/js/images/logo.png*/></a></h1>').insertBefore('.chaser .menu');
    ...
    tjq('a[data-toggle="tab"]').on('http://www.soaptheme.net/html/travelo/js/shown.bs.tab', function (e) {
