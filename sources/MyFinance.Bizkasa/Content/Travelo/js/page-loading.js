...
if (typeof Pace != "undefined") {
    ...
    //document.write('<img alt="" src="logo2.png"/*tpa=http://www.soaptheme.net/html/travelo/js/images/logo2.png*/ style="display: none;">');
    var logoImg = new Image();
    logoImg.src = "logo2.png"/*tpa=http://www.soaptheme.net/html/travelo/js/images/logo2.png*/;
                                                    ...
                                                    '<div class="container">' +
                                                            '<h1 class="logo block">' +
                                                                '<a title="Travelo" href="#">' +
                                                                    '<img alt="" src="logo2.png"/*tpa=http://www.soaptheme.net/html/travelo/js/images/logo2.png*/>' +
                                                                '</a>' +
                                                            '</h1>' +
