...
namespace MyFinance.Bizkasa.Areas.CPanelAdmin.Controllers
{
    public class ReportController : Controller
    {
        ...
        public ActionResult ShiftHistory()
        {
            return View();
        }
        ...
        {
            var result = _Service.Revenue(filter);
            return result.ToJsonResult(result.Data);
        }

        [HttpPost]
        public JsonResult ShiftHistory(InvoiceFilterModel filter)
        {
            var result = _Service.ShiftHistory(filter);
            return result.ToJsonResult(result.Data);
        }
    }
}